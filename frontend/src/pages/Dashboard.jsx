...
const ChangeMapView = ({ bounds, center, zoom, duration = 0.8 }) => {
  const map = useMap();
  ...
  }, [bounds, center, zoom, map, duration]);
          ...
          >
            ...
            >
              ...
              {[
                ...
                >
                  ...
                  <div style={{ fontSize: 12, color: "#6b7280" }}>
                    {index === 0 ? "Good" : index === 1 ? "Watch" : "Critical"}
                  </div>
                </div>
              ))}
              ...
              <div style={{ marginTop: 10 }}>
                <div
                  style={{ fontWeight: 800, marginBottom: 8, color: DARK_GREY }}
                >
                  Selected State
                </div>
            ...
            {[
              ...
              >
                ...
                <div style={{ color: "#64748b", fontSize: 12 }}>{idx + 1}</div>
              </div>
            ))}
          </div>
